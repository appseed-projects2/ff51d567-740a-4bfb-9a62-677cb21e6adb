...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-09-04 14:37`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ff51d567-740a-4bfb-9a62-677cb21e6adb.git
$ cd ff51d567-740a-4bfb-9a62-677cb21e6adb
```
